            ...
            call1.enqueue(new Callback<String>() {
                ...
                public void onResponse(Call<String> call1, Response<String> response) {
                    if (!response.isSuccessful()) {
                        ...
                        Toast.makeText(register2Activity.this, "error :" + response.code(), Toast.LENGTH_LONG).show();
                    } else {
                ...
                public void onFailure(Call<String> call1, Throwable t) {
                    ...
                    Toast.makeText(register2Activity.this, "EL ERROR ESTA ACA: "+t.getLocalizedMessage(), Toast.LENGTH_LONG).show();
                }
            });
        }catch (Exception e){
        }
